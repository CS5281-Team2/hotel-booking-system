                ...
                <div style="flex: 0 0 60%; max-width: 60%; padding-right: 30px;">
                    <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST" id="booking-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="guest_name" name="guest_name" class="form-control" value="<?php echo $_SESSION['user_name']; ?>" required>
                        </div>
                        
                        <div class="form-group">
                            <label for="guest_email">Email</label>
                            <input type="email" id="guest_email" name="guest_email" class="form-control" value="<?php echo $_SESSION['user_email']; ?>" required>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div style="display: flex; margin-bottom: 20px;">
                                <img src="https://via.placeholder.com/100x100?text=<?php echo str_replace(' ', '+', $room['type']); ?>" alt="<?php echo $room['type']; ?>" style="width: 100px; height: 100px; object-fit: cover; border-radius: 4px; margin-right: 15px;">
                                <div>
                                    <h3><?php echo $room['type']; ?></h3>
                                    <p><?php echo $room['breakfast'] == 'Yes' ? 'Breakfast Included' : 'No Breakfast'; ?></p>
                                </div>
                            </div>
                            ...
                            <div style="display: flex; justify-content: space-between; font-size: 1.2rem; font-weight: bold; border-top: 1px solid #ddd; padding-top: 15px;">
                                <p>Total</p>
                                <p>$<?php echo number_format($totalPrice, 2); ?></p>
                            </div>
                        </div>
