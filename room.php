    ...
    <div class="container">
        <div style="display: flex; flex-wrap: wrap;">
            ...
            <div style="flex: 0 0 60%; max-width: 60%; padding-right: 30px;">
                <img src="https://via.placeholder.com/800x500?text=<?php echo str_replace(' ', '+', $room['type']); ?>" alt="<?php echo $room['type']; ?>" style="width: 100%; border-radius: 8px; margin-bottom: 20px;">
                ...
                <p>Free cancellation up to 24 hours before check-in. Cancellations made within 24 hours of check-in are subject to a one-night charge.</p>
            </div>
            ...
            <div style="flex: 0 0 40%; max-width: 40%;">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p style="font-size: 1.5rem; margin-bottom: 10px;"><strong>$<?php echo $room['price']; ?></strong> <span style="font-size: 1rem;">per night</span></p>
