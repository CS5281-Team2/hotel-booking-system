...
<section
    style="background-image: url('assets/images/banner.jpg'); background-size: cover; background-position: center; height: 600px; position: relative;">
    <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.4);">
    </div>
    <div class="container"
        style="position: relative; height: 100%; display: flex; flex-direction: column; justify-content: center;">
        <h1 style="color: white; font-size: 3rem; margin-bottom: 1rem;">Experience Luxury Like Never Before</h1>
        <p style="color: white; font-size: 1.2rem; margin-bottom: 2rem; max-width: 600px;">Indulge in the perfect blend
            of elegance, comfort, and world-class service at our Luxury Hotel.</p>
        ...
        <div class="room-grid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="room-icons" style="display: flex; flex-direction: row; align-items: center;">
                        <span class="icon-item" style="display: inline-flex; align-items: center; margin-right: 20px;">
                            <i class="fas fa-user" style="margin-right: 6px;"></i> <?php echo $room['capacity']; ?>
                        </span>
                        <?php if ($room['breakfast'] == 'Yes'): ?>
                        <span class="icon-item" style="display: inline-flex; align-items: center; margin-right: 20px;">
                            <i class="fas fa-utensils" style="margin-right: 6px;"></i>
                        </span>
                        <?php endif; ?>
                        <span class="icon-item" style="display: inline-flex; align-items: center;">
                            <i class="fas fa-wifi" style="margin-right: 6px;"></i>
                        </span>
                    </div>

                    <p><strong>From $<?php echo $room['price']; ?> per night</strong></p>
                    <a href="room.php?id=<?php echo $room['id']; ?>" class="btn btn-primary"><i
